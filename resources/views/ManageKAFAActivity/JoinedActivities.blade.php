        ...
        <div class="col-12">
          <div class="card mb-4 border border-dark">
            <div class="card-header pb-0" style="display: flex; justify-content: space-between; align-items: center;">
              <p class="font-weight-bold mx-0">Upcoming Joined Activities</p>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    @if ($groupedUpcomingActivities != null)
                    @foreach ($groupedUpcomingActivities as $activityID => $activityData)
                    <tr>
          ...
          <div class="card mb-4 border border-dark">
            <div class="card-header pb-0" style="display: flex; justify-content: space-between; align-items: center;">
              <p class="font-weight-bold mx-0">Past Joined Activities</p>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    @if ($groupedPastActivities != null)
                    @foreach ($groupedPastActivities as $activityID => $activityData)
                    <tr>
                      <td class="align-middle text-center text-secondary text-xs font-weight-bold">
                        {{ $loop->iteration }}</td>
                      <td class="align-middle text-center text-secondary text-xs font-weight-bold">
