...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
  ...
  <div class="w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ Route::currentRouteName() == 'result-list' ? 'active' : '' }}"
          href="{{route('results-list')}}">
          <div
            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link {{ Route::currentRouteName() == 'listbulletin' ? 'active' : '' }}" href="{{route('listbulletin')}}">
          <div
            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link {{ Route::currentRouteName() == 'joined-activities' ? 'active' : '' }}" href="/JoinedActivities">
          <div
            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa fa-bookmark text-dark text-sm opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1">Joined Activities</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ Route::currentRouteName() == 'result-list' ? 'active' : '' }}"
      ...
      <li class="nav-item">
        <a class="nav-link {{ Route::currentRouteName() == 'parentbulletin' ? 'active' : '' }}" href="{{route('parentbulletin')}}">
          <div
            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-notification-70 text-dark text-sm opacity-10"></i>
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ Route::currentRouteName() == 'show-report' ? 'active' : '' }}" href="{{route('results-list')}}">
          <div
            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa fa-list-alt text-dark text-sm opacity-10"></i>
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ Route::currentRouteName() == 'teacherbulletin' ? 'active' : '' }}" href="{{route('teacherbulletin')}}">
          <div
            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-notification-70 text-dark text-sm opacity-10"></i>
          </div>
